...
namespace WWB.Paylink.Utility.Converter
{
    ...
    public static class SafeJsonConvertExtensions
    {
        ...
        {
            return jToken.ToObjectCollectionSafe(objectType, JsonSerializer.CreateDefault());
        }
        ...
        {
            return (T)jToken.ToObjectCollectionSafe(typeof(T));
        }

        public static T ToObjectCollectionSafe<T>(this JToken jToken, JsonSerializer jsonSerializer)
        {
            return (T)jToken.ToObjectCollectionSafe(typeof(T), jsonSerializer);
        }
    }
}