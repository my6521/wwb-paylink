...
{
public class BarcodePayRequest : AbstractRequest, IBaoFooPayRequest<BarcodePayResponse>
{
    #region 属性
    ...
    [JsonProperty("memo")]
    public BarcodePayRequestMemo Memo { get; set; }
