...
namespace WWB.Paylink.Baofu.Transfer.Dtos
{
    public class TransReqData
    {
        ...
        /// 收款人银行名称。必填
        /// </summary>
        [JsonProperty("to_bank_name")]
        public string ToBankName { get; set; }

        /// <summary>
        /// 收款人开户行省名。对公必填，对私不填
        /// </summary>
        [JsonProperty("to_pro_name")]
        public string ToProName { get; set; }

        /// <summary>
        /// 联行号
        /// </summary>
        [JsonProperty("trans_cnap")]
        public string TransCnap { get; set; }
        ...
        /// 银行卡身份证件号码。对公不填，对私必填
        /// </summary>
        [JsonProperty("trans_card_id")]
        public string TransCardId { get; set; }

        /// <summary>
        /// 银行卡预留手机号。对公不填，对私必填
        /// </summary>
        [JsonProperty("trans_mobile")]
