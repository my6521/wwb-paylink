...
namespace WWB.Paylink.Baofu.Transfer.Dtos
{
    public class TransNotifyData
    {
        ...
        /// 宝付订单号
        /// </summary>
        [XmlElement("trans_orderid")]
        public string TransOrderId { get; set; }

        /// <summary>
        /// 宝付批次号
        /// </summary>
        [XmlElement("trans_batchid")]
        ...
        /// 转账金额
        /// </summary>
        [XmlElement("trans_money")]
        public string TransMoney { get; set; }

        /// <summary>
        /// 收款人姓名
        /// </summary>
        [XmlElement("to_acc_name")]
        public string ToAccName { get; set; }

        /// <summary>
        /// 收款人银行帐号
        /// </summary>
        [XmlElement("to_acc_no")]
        public string ToAccNo { get; set; }

        /// <summary>
        /// 交易手续费
        /// </summary>
        [XmlElement("trans_fee")]
