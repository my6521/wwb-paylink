...
/// 代付交易接口
/// </summary>
public class TransferRequest_BF0040001 : IBaofPayRequest<TransferResponse_BF0040001>
{
    private string contentType = HttpContentType.PostFormUrlencoded;
    private string requestUrl = "https://paytest.baofoo.com/baofoo-fopay/pay/BF0040001.do";
    ...
    private TransContent<TransReqData_BF0040001> transContent;
    ...
    public void SetTransReqDatas(List<TransReqData_BF0040001> list)
    {
        if (list.Count > 5)
        {
        ...
        transContent = new TransContent<TransReqData_BF0040001>()
        {
            trans_reqDatas = new List<TransReqDatas<TransReqData_BF0040001>>()
            {
                new TransReqDatas<TransReqData_BF0040001>()
                {
                    trans_reqData = list
                }
            }
