...
/// 小程序支付
/// </summary>
public class AppletPayRequest : IHsqPayRequest<AppletPayResponse>
{
    private string method = "POLYMERIZE_MAIN_SWEPTN";
    private string version = "1.0";
    private string format = "JSON";
    private string signType = HsqPaySignType.RSA2;
    private string contentType = HttpContentType.PostFormUrlencoded;
    private string requestUrl = "https://test-api.huishouqian.com/api/acquiring";
